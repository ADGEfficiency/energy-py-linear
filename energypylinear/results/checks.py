...
def check_electricity_balance(
    ...
    logger.info(f"checks.check_electricity_balance, aggs={aggregated}")
...
def check_high_temperature_heat_balance(
    ...
    aggregated = aggregate_check(debug, {"balance": "all"})
    logger.info(f"checks.check_high_temperature_heat_balance, aggs={aggregated}")
    assert balance.all(), aggregated
    return debug
...
def check_low_temperature_heat_balance(
    ...
    aggregated = aggregate_check(debug, {"balance": "all"})
    logger.info(f"checks.check_low_temperature_heat_balance, aggs={aggregated}")
    assert balance.all(), aggregated
    return debug
